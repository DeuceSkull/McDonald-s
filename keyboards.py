...
def generate_main_menu():
    return ReplyKeyboardMarkup([
        ...
        [KeyboardButton(text='📜 Tarix'), KeyboardButton(text='🛒 Savat'), KeyboardButton(text='⚙ Sozlama')]
    ], resize_keyboard=True)
...
def generate_category_menu():
    ...
    markup.row(
        InlineKeyboardButton(text='Menu', url='https://telegra.ph/Fast-food-MENU-02-18')
    )
